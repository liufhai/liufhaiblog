 ...
 *
 * @package    LIUFHAI
 * @subpackage LiufhaiBlog
 * @since      LiufhaiBlog 3.0.0
 */
 ...
 * 提示框
 */
// 获取LiufhaiBlog自定义的提示框样式，调用样式[primary]内容[/primary]
 ...
 * 按钮
 */
// 获取LiufhaiBlog自定义的按钮样式-primary，调用样式[btn-primary href=""]内容[/btn-primary]
...
// 获取LiufhaiBlog自定义的按钮样式-inverse，调用样式[btn-inverse href=""]内容[/btn-inverse]
