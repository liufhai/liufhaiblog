...
<body <?php body_class(); ?>>
  <header id="zan-header">
    <div class="header">
        <div class="container">
            <div class="col-sm-12">
                <h1><a href="<?php echo home_url( '/' ); ?>" title="" data-original-title="<?php echo bloginfo('name');?>"><?php echo bloginfo('name');?></a></h1>
                <h1 class="hide"><a href="<?php echo home_url( '/' ); ?>" title="" data-original-title="WEB资源网"><img src="http://webres.wang/wp-content/themes/GoL/assets/images/logo.png"></a></h1>
                <h2 class="h4"><?php echo get_bloginfo( 'description', 'display' );?></h2>
            </div>
        </div>
