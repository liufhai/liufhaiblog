				...
				<article class="zan-article">
					...
					<div class="hidden-xs">
						...
						<p class="post-big-info">
	                        <span class="label-zan"><i class="fa fa-calendar"></i> <?php the_time( 'm月j日, Y' ); ?></span>
							<span class="label-zan"><i class="fa fa-tags"></i> <?php the_category(' '); ?></span>
							<span class="label-zan"><i class="fa fa-user"></i> <?php the_author_posts_link(); ?></span>
							<span class="label-zan"><i class="fa fa-eye"></i> <?php if( function_exists( 'the_views' ) ) { the_views(); }else{echo 0;} ?></span>
						</p>
					</div>
					<!-- 大型设备文章显示结束 -->
					<!-- 小型设备文章显示 -->
          ...
          <article class="zan-single-content">				                 
	        ...
	        <div class="zan-share clearfix">
		        <div class="bdsharebuttonbox pull-right">
					...
					<!-- 百度分享结束 -->
					<!-- 文章版权信息 -->
					<div class="copyright well single_copy">
						<p>
							版权属于:
							<?php
								if( get_post_meta( $post->ID, "版权属于:", true ) ) {
									...
									echo '<a href="http://blog.qqnit.com" target="_blank">'.the_author_posts_link().'</a>';
								}
							?>
						</p>
						<p>
